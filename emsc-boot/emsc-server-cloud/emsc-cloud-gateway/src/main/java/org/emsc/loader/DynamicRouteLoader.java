...
import org.emsc.config.GatewayRoutersConfig;
import org.emsc.config.RouterDataType;
import org.emsc.loader.repository.DynamicRouteService;
import org.emsc.loader.repository.MyInMemoryRouteDefinitionRepository;
import org.emsc.loader.vo.MyRouteDefinition;
import org.emsc.loader.vo.PredicatesVo;
...
//    }
    ...
    private void loadRoutesByNacos() {
        ...
        try {
            log.info("我看一看是什么jeecg.route.config.data-id = {}", gatewayRoutersConfig.getDataId());
