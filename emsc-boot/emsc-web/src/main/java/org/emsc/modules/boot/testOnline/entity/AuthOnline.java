package org.emsc.modules.boot.testOnline.entity;
 ...
 */
@Data
@TableName("auth_online")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="auth_online对象", description="权限自动生成验证")
public class AuthOnline implements Serializable {
