...
//	}
	...
	public Result<?> getUserPermissionByToken(HttpServletRequest request,String view) {
		...
		try {
			...
			List<SysPermission> metaList = sysPermissionService.queryByUser(loginUser.getId(),view);
			//添加首页路由
